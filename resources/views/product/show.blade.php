                ...
                <div class="details_image">
                    @php
                        ...
                        if(count($item->images)>0) 
                            ...
                            $image = 'no_image.png';
                    @endphp
                    <div class="details_image_large"><img src="/images/{{$image}}" alt="{{$item->title}}"><div class="product_extra product_new"><a>New</a></div></div>
                    ...
                    @foreach ($products as $product)
						...
						@endphp
							<div class="product">
								...
								<div class="product_extra product_new"><a href="categories.html"></a>{{$product->category['title']}}</div>
