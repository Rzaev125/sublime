...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="header_extra ml-auto d-flex">
								<div>
									<ul class="d-flex" style="line-height: 35px;">
										@if (Auth::check())
											<li style="padding-right: 20px;"><img style='display:block;width:45px;height:40px;'
												src="data:image/jpeg;base64,{{base64_encode(Auth::user()->image)}}"/></li>
								...
								<div class="shopping_cart" style="line-height: 35px;">
								...
								<div class="hamburger"><i class="fa fa-bars" aria-hidden="true" style="line-height: 35px;"></i></div>
							</div>
						</div>
					</div>
				</div>
	...
	<footer class="footer">
		...
		<div class="container-xl" style="width: 100%!important">
			<div class="footer_background" style="background-image:url(/images/footer.jpg)"></div>
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center" style="text-align: center">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
						<div class="footer_social ml-lg-auto" style="text-align: center">
							<ul>
								<li><a href="#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
								<li><a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
								<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
